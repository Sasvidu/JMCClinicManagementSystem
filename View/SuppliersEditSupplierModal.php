...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <form action="../Controller/SuppliersEditSupplierModalController.php?status=true" method="post">

            <div class="modal-header">
                <h5 id="UpdateSupplierModalTitle" class="modal-title">Edit Supplier Information</h5>
