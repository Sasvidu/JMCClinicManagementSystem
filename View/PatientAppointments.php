                                        ...
                                        <?php foreach ($appointments as $appointment) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        <button type="button" class="btn btn-sm btn-success btn-action" name="viewPrescriptionButton" id="viewPrescription<?php echo $appointment['appointment_id'] ?>" style="width:10rem;"><i class="fa-solid fa-file-lines"></i>&nbsp;View Prescription</button>
                                                    <?php } ?>
