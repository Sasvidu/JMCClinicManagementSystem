...
require_once "../Model/DoctorScheduleInitializationModel.php";
                ...
                <form action="../Controller/DashboardController.php?status=true" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 dashboard-item">
                            ...
                            <button name="dashboard-submit" value="dashboard-submit-schedules" type="submit" class="dashboard-btn dashboard-selected-item">
                            ...
                            <div class="col-8">
                                ...
                                <nav class="paginationNav">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="DoctorSchedules.php?page=1">First</a>
                                        </li>

                                        <li class="page-item <?php if ($page == 1 || $page == 0) {echo "disabled";} ?>">
                                            <a class="page-link" href="DoctorSchedules.php?page=<?php echo $previous; ?>">Previous</a>
                                        </li>

                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>

                                            <li class="page-item<?php if ($i == $page) {echo " active";} ?>">
                                                <a class="page-link" href="DoctorSchedules.php?page=<?php echo $i; ?>"> <?php echo $i; ?> </a>
                                            </li>

                                        <?php } ?>

                                        <li class="page-item <?php if ($page == $pages || $page == 0) {echo "disabled";} ?>">
                                            <a class="page-link" href="DoctorSchedules.php?page=<?php echo $next; ?>">Next</a>
                                        </li>

                                        <li class="page-item">
                                            <a class="page-link" href="DoctorSchedules.php?page=<?php echo $pages; ?>">Last</a>
                                        </li>
