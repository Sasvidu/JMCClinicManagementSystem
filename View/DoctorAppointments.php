...
require_once "../Model/DoctorAppointmentInitializationModel.php";
                ...
                <form action="../Controller/DashboardController.php?status=true" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 dashboard-item">
                            ...
                            <button name="dashboard-submit" value="dashboard-submit-appointments" type="submit" class="dashboard-btn dashboard-selected-item">
                                        ...
                                        <?php foreach ($appointments as $appointment) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        <button type="button" class="btn btn-sm btn-success btn-action" name="viewPrescriptionButton" id="viewPrescription<?php echo $appointment['prescription_id'] ?>" onclick="openPrescriptionReport(this.id)"><i class="fa-solid fa-file-lines"></i>&nbsp;View Prescription</button>
                                                    <?php } ?>
