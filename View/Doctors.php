...
require_once "../Model/DoctorsInitializationModel.php";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/DoctorsStyles.css">
    ...
    <script defer src="../JS/DoctorsJS.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-12 main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <nav class="paginationNav">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="Doctors.php?page=1">First</a>
                                        </li>

                                        <li class="page-item <?php if ($page == 1 || $page == 0) {echo "disabled";} ?>">
                                            <a class="page-link" href="Doctors.php?page=<?php echo $previous; ?>">Previous</a>
                                        </li>

                                        <?php for ($i = 1; $i <= $pages; $i++) { ?>

                                            <li class="page-item<?php if ($i == $page) {echo " active";} ?>">
                                                <a class="page-link" href="Doctors.php?page=<?php echo $i; ?>"> <?php echo $i; ?> </a>
                                            </li>

                                        <?php } ?>

                                        <li class="page-item <?php if ($page == $pages || $page == 0) {echo "disabled";} ?>">
                                            <a class="page-link" href="Doctors.php?page=<?php echo $next; ?>">Next</a>
                                        </li>

                                        <li class="page-item">
                                            <a class="page-link" href="Doctors.php?page=<?php echo $pages; ?>">Last</a>
                                        </li>
                            ...
                            <div class="col-1">
                                <button type="button" class="btn btn-block btn-themed-success btn-add-doctor" name="addDoctorButton" id="addDoctorButton" data-toggle="modal" data-target="#AddDoctorModal"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Doctor</button>
                            </div>
                                ...
                                <table class="table table-striped table-hover table-bordered table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($doctors as $doctor) { ?>
                                            <tr>
                                                <th scope="row"><?php echo $doctor['doctor_id']; ?></th>
                                                <td id="DoctorName<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['user_fname'] . " " . $doctor['user_lname']; ?></td>
                                                <td id="DoctorSpecialisation<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['doctor_specialisation']; ?></td>
                                                <td> 
                                                    <?php echo "<textarea id='DoctorQualifications" . $doctor['doctor_id'] . "' rows='2'>" . $doctor['doctor_qualifications'] . "</textarea>" ?>
                                                </td>
                                                <td> 
                                                    <?php echo "<textarea id='DoctorExperience" . $doctor['doctor_id'] . "' rows='2'>" . $doctor['doctor_experience'] . "</textarea>" ?>
                                                </td>
                                                <td id="DoctorUserId<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['doctor_user_id']; ?></td>
                                                <td id="DoctorTelNo<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['doctor_tel_no']; ?></td>
                                                <td id="DoctorEmail<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['user_email']; ?></td>
                                                <td> 
                                                    <?php echo "<textarea id='DoctorAddress" . $doctor['doctor_id'] . "' rows='2'>" . $doctor['user_address'] . "</textarea>" ?>
                                                </td>
                                                <td id="DoctorDateOfBirth<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['user_dob']; ?></td>
                                                <td id="DoctorNIC<?php echo $doctor['doctor_id']; ?>"> <?php echo $doctor['user_nic']; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-themed-danger btn-action" name="deleteButton" id="del<?php echo $doctor['doctor_id'] ?>" onclick="openDeleteModal(this.id)"><i class="fa-solid fa-trash-can"></i>&nbsp;Delete</button>
                                                    <button type="button" class="btn btn-sm btn-themed-info" name="editButton" id="edit<?php echo $doctor['doctor_id'] ?>" onclick="openEditModal(this.id)"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Edit</button>
                                                </td>
                                            </tr>
                                        <?php } ?>
