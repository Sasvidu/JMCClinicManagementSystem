...
require_once "../Model/MedicineInitializationModel.php";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/MedicineStyles.css">
    ...
    <script defer src="../JS/MedicineJS.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-12 main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                <button type="button" class="btn btn-block btn-themed-success btn-add-medicine" name="addMedicineButton" id="addMedicineButton" data-toggle="modal" data-target="#AddMedicineModal"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Medicine</button>
                            </div>
                                ...
                                <table class="table table-striped table-hover table-bordered table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($medicines as $medicine) { ?>
                                            <tr>
                                                <th scope="row"><?php echo $medicine['medicine_id']; ?></th>
                                                <td id="MedicineName<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_name']; ?></td>
                                                <td id="MedicineBatch<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_batch_no']; ?></td>
                                                <td id="MedicineBrand<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_brand']; ?></td>
                                                <td id="MedicineCompany<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_company']; ?></td>
                                                <td id="MedicineCategory<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_category']; ?></td>
                                                <td id="MedicineSize<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_size']; ?></td>
                                                <td id="MedicinePrice<?php echo $medicine['medicine_id']; ?>"> <?php echo $medicine['medicine_price']; ?></td>
                                                <td> 
                                                    <?php echo "<textarea id='MedicineInfo" . $medicine['medicine_id'] . "' rows='2'>" . $medicine['medicine_info'] . "</textarea>" ?>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-themed-danger btn-action" name="deleteButton" id="del<?php echo $medicine['medicine_id'] ?>" onclick="openDeleteModal(this.id)"><i class="fa-solid fa-trash-can"></i>&nbsp;Delete</button>
                                                    <button type="button" class="btn btn-sm btn-themed-info" name="editButton" id="edit<?php echo $medicine['medicine_id'] ?>" onclick="openEditModal(this.id)"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Edit</button>
                                                </td>
                                            </tr>
                                        <?php } ?>
